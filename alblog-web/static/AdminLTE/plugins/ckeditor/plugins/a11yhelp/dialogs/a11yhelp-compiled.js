...
CKEDITOR.dialog.add("a11yHelp", function (j) {
  ...
  var e = [CKEDITOR.ALT, CKEDITOR.SHIFT, CKEDITOR.CTRL],
    ...
    var o = j.keystrokeHandler.keystrokes,
        f = {},
        b;for (b in o) f[o[b]] = b;return function (b, g) {
      var a;if (f[g]) {
        a = f[g];for (var h, i, k = [], c = 0; c < e.length; c++) i = e[c], h = a / e[c], 1 < h && 2 >= h && (a -= i, k.push(d[i]));k.push(d[a] || String.fromCharCode(a));a = k.join("+");
      } else a = b;return a;
    };
        ...
        focus: function () {
          ...
          for (var d = '<div class="cke_accessibility_legend" role="document" aria-labelledby="' + m + '_arialbl" tabIndex="-1">%1</div><span id="' + m + '_arialbl" class="cke_voice_label">' + l.contents + " </span>", f = [], b = l.legend, j = b.length, g = 0; g < j; g++) {
            for (var a = b[g], h = [], i = a.items, k = i.length, c = 0; c < k; c++) {
              var e = i[c],
                  p = e.legend.replace(n, q);p.match(n) || h.push("<dt>%1</dt><dd>%2</dd>".replace("%1", e.name).replace("%2", p));
...
//# sourceMappingURL=a11yhelp-compiled.js.map